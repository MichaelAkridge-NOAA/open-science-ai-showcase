...
- **Model Card:** [Hugging Face Model Card]([https://huggingface.co/akridge/yolo11-fish-detector-grayscale](https://huggingface.co/akridge/noaa-esd-coral-bleaching-vit-classifier-v1))
- **Example:**
